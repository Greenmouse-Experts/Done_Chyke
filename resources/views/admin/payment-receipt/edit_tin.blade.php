...
<div class="content-page">
    <div class="col-lg-12">
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
            <div>
                <h4 class="mb-3">Edit Tin Payment Receipts</h4>
            </div>
                        ...
                        <div class="tab-content" id="pills-tabContent-1">
                            <div class="tab-pane fade active show" id="pills-pound-fill" role="tabpanel" aria-labelledby="pills-home-tab-fill">
                                <div class="card" style="border: 1px solid #c7cbd3 !important;">
                                    <div class="card-body">
                                        <form id="preview-button" action="{{route('admin.payment.receipt.tin.pound.update', Crypt::encrypt($tinPayment->id))}}" method="POST" data-toggle="validator" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter supplier name" name="supplier" value="{{$tinPayment->supplier}}"required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="selectpicker form-control" data-style="py-0" name="grade" required>
                                                            <option value="{{$tinPayment->grade}}">{{App\Models\BeratingCalculation::find($tinPayment->grade)->grade}}</option>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label>Weight *</label>
                                                        <br>
                                                        <input type="radio" name="weight" value="bag" @if($tinPayment->bag !== 0) checked @endif/> Bag
                                                        <input type="radio" name="weight" style="margin-left: 2rem;" value="pound" @if($tinPayment->bag == 0) checked @endif/> Pound
                                                    </div>
                                                </div>
                                                <div id="weightbag" class="desc col-12" style="display: none;">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Bag</label>
                                                                <input type="number" class="form-control" placeholder="Enter bags value" value="{{$tinPayment->bag}}" name="bags">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="manager" class="selectpicker form-control" data-style="py-0" required>
                                                            <option value="{{$tinPayment->staff}}">{{App\Models\User::find($tinPayment->staff)->name}}</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Enter date" name="date_of_purchase" value="{{$tinPayment->date_of_purchase}}" required>
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter receipt number" name="receipt_no" value="{{$tinPayment->receipt_no}}"required>
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control" placeholder="Upload receipt" name="receipt_image" value="{$tinPayment->receipt_image}}" accept="image/png, image/jpeg, image/jpg">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label>Weight *</label>
                                                        <br>
                                                        <input type="radio" name="kgweight" value="bag" @if($tinPayment->bag !== 0) checked @endif/> Bag
                                                        <input type="radio" name="kgweight" style="margin-left: 2rem;" value="kg" @if($tinPayment->bag == 0) checked @endif/> Kg
                                                    </div>
                                                </div>
