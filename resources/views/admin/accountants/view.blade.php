                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                        <a class="badge badge-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="View/Edit" href="{{route('admin.edit.accountant', Crypt::encrypt($accountant->id))}}"><i class="ri-eye-line mr-0"></i></a>
                                        @if($accountant->status == '1')
                                        <a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Deactivate"href="{{route('admin.deactivate.staff', Crypt::encrypt($accountant->id))}}"><i class="ri-stop-circle-line mr-0"></i></a>
                                        @else
                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Active" href="{{route('admin.activate.staff', Crypt::encrypt($accountant->id))}}"><i class="ri-play-line mr-0"></i></a>
                                        @endif
                                        <a class="badge bg-danger mr-2" data-toggle="modal" data-target="#delete-{{$accountant->id}}" href="#"><i class="ri-delete-bin-line mr-0"></i></a>
