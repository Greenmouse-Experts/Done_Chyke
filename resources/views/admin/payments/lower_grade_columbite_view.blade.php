...
<div class="content-page">
    <div class="col-lg-12">
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
            <div>
                <h4 class="mb-3">Lower Grade Columbite Payment Transaction</h4>
            </div>

            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}"><i class="ri-home-4-line mr-1 float-left"></i>Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Lower Grade Columbite Payments</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="pills-tabContent-2">
                            <div class="tab-pane fade @if($active_tab == 'pound') active show @endif" id="pills-pound" role="tabpanel" aria-labelledby="pills-pound-tab">
                                <div class="table-responsive rounded mb-3">
                                    <div class="d-flex flex-wrap align-items-center justify-content-end mb-4">
                                        <form action="{{ route('admin.payments.lower.grade.columbite.view', 'pound')}}" method="POST" data-toggle="validator">
                                            @csrf
                                    ...
                                    <table class="data-table table mb-0 tbl-server-info">
                                        ...
                                        <tbody class="ligth-body">
                                            ...
                                            @php
                                                if(App\Models\Payment::where(['receipt_title' => 'Lower Grade Columbite', 'receipt_type' => 'pound', 'receipt_id' => $receipt->id])->exists())
                                                {
                                                    $poundReceipt = App\Models\Payment::where(['receipt_title' => 'Lower Grade Columbite', 'receipt_type' => 'pound', 'receipt_id' => $receipt->id])->first();
                                                    $totalReceipt = App\Models\Payment::where(['receipt_title' => 'Lower Grade Columbite', 'receipt_type' => 'pound', 'receipt_id' => $receipt->id])->get();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center list-action">
                                                        @if($id <> null)
                                                        <a class="badge badge-primary mr-2" data-toggle="tooltip" data-placement="top" title="View Payment Details" data-original-title="View Payment Details" href="{{route('admin.payments.view.details', Crypt::encrypt($id))}}">View Details</a>
                                                        @endif
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td colspan="5" style="font-size: 1.1rem; font-weight: 700">₦{{number_format($lowergradecolumbitePaymentReceiptPound->sum('price'), 2)}}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="tab-pane fade @if($active_tab == 'kg') active show @endif" id="pills-kg" role="tabpanel" aria-labelledby="pills-kg-tab">
                                <div class="table-responsive rounded mb-3">
                                    <div class="d-flex flex-wrap align-items-center justify-content-end mb-4">
                                        <form action="{{ route('admin.payments.lower.grade.columbite.view', 'kg')}}" method="POST" data-toggle="validator">
                                            @csrf
                                            <label class="mr-2"><strong>Start Date :</strong>
                                    ...
                                    <table class="data-table table mb-0 tbl-server-info">
                                        ...
                                        <tbody class="ligth-body">
                                            ...
                                            @php
                                                if(App\Models\Payment::where(['receipt_title' => 'Lower Grade Columbite', 'receipt_type' => 'kg', 'receipt_id' => $receipt->id])->exists())
                                                {
                                                    $kgReceipt = App\Models\Payment::where(['receipt_title' => 'Lower Grade Columbite', 'receipt_type' => 'kg', 'receipt_id' => $receipt->id])->first();
                                                    $totalReceipt = App\Models\Payment::where(['receipt_title' => 'Lower Grade Columbite', 'receipt_type' => 'kg', 'receipt_id' => $receipt->id])->get();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center list-action">
                                                        @if($kgid <> null)
                                                        <a class="badge badge-primary mr-2" data-toggle="tooltip" data-placement="top" title="View Payment Details" data-original-title="View Payment Details" href="{{route('admin.payments.view.details', Crypt::encrypt($kgid))}}">View Details</a>
                                                        @endif
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="4" style="font-size: 1.1rem; font-weight: 700">Total</td>
                                                <td colspan="5" style="font-size: 1.1rem; font-weight: 700">₦{{number_format($lowergradecolumbitePaymentReceiptKg->sum('price'), 2)}}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
