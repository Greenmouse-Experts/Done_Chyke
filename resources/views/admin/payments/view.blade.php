                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        @if(isset($full_payment) && $full_payment->receipt_title == 'Tin' ?? isset($part_payment) && $part_payment->receipt_title == 'Tin')
                            ...
                            <a href="{{route('admin.payments.tin.view', 'kg')}}">Tin Receipt</a>
                            @else
                            <a href="{{route('admin.payments.tin.view', 'pound')}}">Tin Receipt</a>
                            @endif
                        @elseif(isset($full_payment) && $full_payment->receipt_title == 'Columbite' ?? isset($part_payment) && $part_payment->receipt_title == 'Columbite')
                            @if(isset($full_payment) && $full_payment->receipt_type == 'kg' ?? isset($part_payment) && $part_payment->receipt_type == 'kg')
                            <a href="{{route('admin.payments.columbite.view', 'kg')}}">Columbite Receipt</a>
                            @else
                            <a href="{{route('admin.payments.columbite.view', 'pound')}}">Columbite Receipt</a>
                            @endif
                        @else
                            @if(isset($full_payment) && $full_payment->receipt_type == 'kg' ?? isset($part_payment) && $part_payment->receipt_type == 'kg')
                            <a href="{{route('admin.payments.lower.grade.columbite.view', 'kg')}}">Lower Grade Columbite</a>
                            @else
                            <a href="{{route('admin.payments.lower.grade.columbite.view', 'pound')}}">Lower Grade Columbite</a>
                            @endif
                        @endif
                    </li>
