                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div style="justify-content: flex-start;">
                            <form action="{{ route('admin.weekly.material.summary.tin.kg')}}" method="POST" data-toggle="validator">
                                @csrf
                    ...
                    <div class="w-100">
                        ...
                        <div class="row w-100 mt-5">
                            <div class="col">
                                ...
                                <p style="font-size: 32px; margin-top: 15px;">{{$data['18M']['bags']}}<sup>{{$data['18M']['kgs']}}</sup></p>
                            </div>
                            <div class="col">
                                <p style="font-weight:600; font-size:18px">19 Material</p>
                                <p style="font-size: 32px; margin-top: 15px;">{{$data['19M']['bags']}}<sup>{{$data['19M']['kgs']}}</sup></p>
                            </div>
                            <div class="col">
                                <p style="font-weight:600; font-size:18px">20 Material</p>
                                <p style="font-size: 32px; margin-top: 15px;">{{$data['20M']['bags']}}<sup>{{$data['20M']['kgs']}}</sup></p>
                            </div>
                            <div class="col">
                                <p style="font-weight:600; font-size:18px">Total (bags)</p>
                                <p style="font-size: 32px; margin-top: 15px;">{{$data['TOTAL_BAGS']['bags']}}<sup>{{$data['TOTAL_BAGS']['kgs']}}</sup></p>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <p style="font-size: 32px; margin-top: 15px;">{{$data['AP']}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-100">
                        <div class="row w-100 mt-5">
                            ...
                            <div class="col">
                                ...
                                <p style="font-size: 32px; margin-top: 15px;">{{$data['AVGPRICE']}}per kg</p>
                            </div>
                        </div>
                    </div>
                </div>
