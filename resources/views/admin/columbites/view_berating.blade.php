        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">Columbite Berating List</h4>
                        <p class="mb-0">All analysis price for columbiite in one Place </p>
                    </div>
                    <a href="{{route('admin.add.columbite.berating')}}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Berating</a>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="table-responsive rounded mb-3">
                    <table class="data-table table mb-0 tbl-server-info">
                        ...
                        <tbody class="ligth-body">
                            @foreach(App\Models\ColumbiteBerating::latest()->get() as $berating)
                            <tr>
                                <td>
                                    <div class="checkbox d-inline-block">
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="popup text-left">
                                                            ...
                                                            <div class="content create-workform bg-body">
                                                                <form action="{{route('admin.update.columbite.berating', Crypt::encrypt($berating->id))}}" method="POST" data-toggle="validator">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                        ...
                                        @if($berating->status == 'Active')
                                        <a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Deactivate"href="{{route('admin.deactivate.columbite.berating', Crypt::encrypt($berating->id))}}"><i class="ri-stop-circle-line mr-0"></i></a>
                                        @else
                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Active" href="{{route('admin.activate.columbite.berating', Crypt::encrypt($berating->id))}}"><i class="ri-play-line mr-0"></i></a>
                                        @endif
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="popup text-left">
                                                            ...
                                                            <div class="content create-workform bg-body">
                                                                <form action="{{route('admin.delete.columbite.berating', Crypt::encrypt($berating->id))}}" method="post">
                                                                    @csrf
