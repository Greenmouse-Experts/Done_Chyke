        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">Columbite Material List</h4>
                        <p class="mb-0">All columbite materials in one place </p>
                    </div>
                    <a href="{{route('admin.add.material.columbite')}}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add</a>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="table-responsive rounded mb-3">
                    <table class="data-table table mb-0 tbl-server-info">
                        ...
                        <tbody class="ligth-body">
                            @foreach(App\Models\ColumbiteMaterial::latest()->get() as $material)
                            <tr>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="popup text-left">
                                                            <div class="content create-workform bg-body">
                                                                <form action="{{route('admin.update.material.columbite', Crypt::encrypt($material->id))}}" method="POST" data-toggle="validator">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="popup text-left">
                                                            ...
                                                            <div class="content create-workform bg-body">
                                                                <form action="{{route('admin.delete.material.columbite', Crypt::encrypt($material->id))}}" method="post">
                                                                    @csrf
