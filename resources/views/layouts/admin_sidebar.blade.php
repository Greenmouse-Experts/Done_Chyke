            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ (request()->is('admin/weekly/material/summary*')) ? 'active' : '' }}">
                    ...
                    <ul id="analysis" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="{{ (request()->is('admin/weekly/material/summary/tin/pound')) ? 'active' : '' }}">
                            <a href="{{route('admin.weekly.material.summary.tin.pound')}}">
                                <i class="las la-minus"></i><span>Tin (Pound)</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('admin/weekly/material/summary/tin/kg')) ? 'active' : '' }}">
                            <a href="{{route('admin.weekly.material.summary.tin.kg')}}">
                                <i class="las la-minus"></i><span>Tin (Kg)</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('admin/weekly/material/summary/columbite/pound')) ? 'active' : '' }}">
                            <a href="{{route('admin.weekly.material.summary.columbite.pound')}}">
                                <i class="las la-minus"></i><span>Columbite (Pound)</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('admin/weekly/material/summary/columbite/kg')) ? 'active' : '' }}">
                            <a href="{{route('admin.weekly.material.summary.columbite.kg')}}">
                                <i class="las la-minus"></i><span>Columbite (Kg)</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('admin/weekly/material/summary/low/grade/pound')) ? 'active' : '' }}">
                            <a href="{{route('admin.weekly.material.summary.low.grade.pound')}}">
                                <i class="las la-minus"></i><span>Low Grade (Pound)</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('admin/weekly/material/summary/low/grade/kg')) ? 'active' : '' }}">
                            <a href="{{route('admin.weekly.material.summary.low.grade.kg')}}">
