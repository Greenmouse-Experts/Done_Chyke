...
<div class="content-page">
    <div class="col-lg-12">
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
            <div>
                <h4 class="mb-3">Add Columbite Payment Receipts</h4>
            </div>

            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}"><i class="ri-home-4-line mr-1 float-left"></i>Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{route('payment.receipt.columbite.view', 'pound')}}">Columbite Payment Receipts</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills mb-3 nav-fill" id="pills-tab-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if($active_tab == 'kg') active @endif" id="pills-pound-tab-fill" data-toggle="pill" href="#pills-kg-fill" role="tab" aria-controls="pills-pound" aria-selected="true">COLUMBITE (KG)</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent-1">
                            <div class="tab-pane fade @if($active_tab == 'pound') active show @endif" id="pills-pound-fill" role="tabpanel" aria-labelledby="pills-home-tab-fill">
                                <div class="card" style="border: 1px solid #c7cbd3 !important;">
                                    <div class="card-body">
                                        <form id="pound-button" action="{{route('payment.receipt.columbite.pound.post', 'pound')}}" method="POST" data-toggle="validator" enctype="multipart/form-data">
                                            @csrf
                            ...
                            <div class="tab-pane fade @if($active_tab == 'kg') active show @endif" id="pills-kg-fill" role="tabpanel" aria-labelledby="pills-kg-tab-fill">
                                <div class="card" style="border: 1px solid #c7cbd3 !important;">
                                    <div class="card-body">
                                        <form id="kg-button" action="{{route('payment.receipt.columbite.kg.post')}}" method="POST" data-toggle="validator" enctype="multipart/form-data">
                                            @csrf
