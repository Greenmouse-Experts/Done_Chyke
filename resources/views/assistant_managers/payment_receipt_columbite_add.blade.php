        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('payment.receipt.columbite.view')}}">Columbite Payment Receipts</a></li>
                        ...
                        <div class="tab-content" id="pills-tabContent-1">
                            <div class="tab-pane fade  @if($active_tab == 'pound') active show @endif" id="pills-pound-fill" role="tabpanel" aria-labelledby="pills-home-tab-fill">
                                <div class="card" style="border: 1px solid #c7cbd3 !important;">
                                    <div class="card-body">
                                        <form id="pound-button" action="{{route('payment.receipt.columbite.pound.post')}}" method="POST" data-toggle="validator" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="poundweightbag" class="desc col-12" style="display: none;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Pound</label>
                                                                <input type="number" class="form-control" placeholder="Enter pound value" onkeyup="this.value = minmax(this.value, null, 79)" value="0" name="bag_pound">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div id="poundweightpound" class="desc col-12" style="display: none;">
                                                    <div class="form-group">
                                                        <label>Pound</label>
                                                        <input type="number" class="form-control" placeholder="Enter pound value" name="pounds">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="mt-5">
                                                <a href="{{route('payment.receipt.columbite.pound.post')}}" onclick="event.preventDefault();
