...
<div class="content-page">
    <div class="col-lg-12">
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
            <div>
                <h4 class="mb-3">Lower Grade Columbite Payments</h4>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center list-action">
                                                        ...
                                                        @else
                                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="Make Payment" data-original-title="Make Payment" href="{{route('payments.process', [Crypt::encrypt($receipt->id), Crypt::encrypt('pound'), Crypt::encrypt('Lower Grade Columbite')])}}">Make Payment</a>
                                                        @endif
                                                        @if($id <> null)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center list-action">
                                                        ...
                                                        <a class="badge bg-success mr-2" href="#">Payment Completed</a>
                                                        @else
                                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="Make Payment" data-original-title="Make Payment" href="{{route('payments.process', [Crypt::encrypt($receipt->id), Crypt::encrypt('kg'), Crypt::encrypt('Lower Grade Columbite')])}}">Make Payment</a>
                                                        @endif
                                                        @if($kgid <> null)
