                                        ...
                                        <div class="p-3">
                                            ...
                                            <form action="{{ route('user.login')}}" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <a href="/forgot" class="text-primary float-right">Forgot Password?</a>
                                                    </div>
                                                </div>
                                                <button type="submit" class="form-btn btn btn-primary full-width" style="width: 100%">Login</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
