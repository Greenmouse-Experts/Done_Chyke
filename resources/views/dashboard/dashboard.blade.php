        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="Hamzat">
                    ...
                    <p>
                        Direct Transfer: <span> ₦200, 000 </span>
                    </p>
                    <p>
                        Transfer by Cheque: <span> ₦400,000 </span>
                    </p>
                </div>
            </div>
            <div class="col-lg-8 mb-4">
                <div class="Hamzat">
                    <div class="row">
                        ...
                        <div class="col-sm-3">Date:Sep 25, 2023</div>
                        <div class="col-sm-2">
                ...
                <div class="Hamzat">
                    ...
                    <div class="mt-3 all">
                        <div class="toast-header">
                            ...
                            <strong class="mr-auto">Hamzat</strong>
                            <small class="float-right">11 mins ago</small>
                        </div>
                        <div class="toast-body">
                          <small>  Hello, world! This is a toast message.</small>
                        </div>
                    </div>
                    <div class="mt-3 all">
                        <div class="toast-header">
